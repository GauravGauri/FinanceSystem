    ...
    <div className="min-h-screen flex bg-white font-sans">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 md:px-24 xl:px-32 relative">
        ...
        <div className="max-w-md w-full mx-auto mt-20">
          <h1 className="text-4xl font-bold text-slate-900 mb-2 font-heading">Welcome back</h1>
          <p className="text-slate-500 mb-10">Enter your details to access your account.</p>
            ...
            {({ isSubmitting }) => (
              <Form className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-4 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-lg shadow-emerald-600/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-lg px-8">
          ...
          <h2 className="text-4xl font-bold text-white mb-6 font-heading">Take control of your wealth.</h2>
          <p className="text-xl text-slate-300 leading-relaxed">Join thousands of others who use GauravMoney to budget smarter, track their net worth, and hit their financial goals.</p>
        </div>
      </div>
    </div>
  );
