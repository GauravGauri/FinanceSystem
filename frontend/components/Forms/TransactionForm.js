...
export default function TransactionForm({ onClose }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md border border-gray-100">
      ...
      <Formik
        initialValues={{ text: '', amount: '', type: 'expense', category: 'Food' }}
        ...
        {({ values, setFieldValue }) => (
          <Form className="space-y-4">
            ...
            <div>
              ...
              <Field as="select" name="category" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-white">
